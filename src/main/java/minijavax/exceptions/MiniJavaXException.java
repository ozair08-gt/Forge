...
public abstract class MiniJavaXException extends RuntimeException {
    private final int line;
    private final int column;

    public MiniJavaXException(String message, int line, int column) {
        super(formatMessage(message, line, column));
        this.line = line;
        this.column = column;
    }

    public MiniJavaXException(String message) {
        super(message);
        this.line = -1;
        this.column = -1;
    }
